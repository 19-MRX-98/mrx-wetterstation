    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_array($result)) {
            ...
            if (mysqli_num_rows($result2) > 0) {
                ...
                // 4. Füge die Monatsmitteltemperatur und die Abweichung in die abweichungen_act_year Tabelle ein
                $insert_stmt = $db->prepare("INSERT INTO abweichungen_act_year (monat, monatsmitteltemperatur, abweichung) VALUES (?, ?, ?)");
