        ...
        $actual_year = date("Y");
            ...
            if($db->connect_errno)
                    ...
                    else
                    {
                        ...
                        ";
                            $get_topwerte = "SELECT Temperatur, DATE_FORMAT(datetime,'%d.%m.%Y') FROM wetterdaten2023 WHERE Temperatur=(SELECT MAX(Temperatur) FROM wetterdaten2023) LIMIT 1;";
                            ...
                            //Vierte Abfrage
                            $get_topwerte4="SELECT (SELECT MAX(Regen) FROM wetterdaten2023)-(SELECT min(Regen) FROM wetterdaten2023) AS Gesamt;";
                            ...
                            $get_warme_tage="SELECT COUNT(*) from tageshöchstwerte23 WHERE Höchstwert BETWEEN 25 AND 29.9";
                            ...
                            $get_heiße_tage="SELECT COUNT(*) from tageshöchstwerte23 WHERE Höchstwert BETWEEN 30 AND 34.9";
                            ...
                            $get_wuesten_tage="SELECT COUNT(*) from tageshöchstwerte23 WHERE Höchstwert >= 35;";
