...
$current_month = date("n");
    $get_connectionstring = new mysqli($dbsrv,$dbuser,$passwd,$database);
        $first_query = "SELECT datetime,Regen FROM wetterdaten01 PARTITION (p_wetterdaten_act_08) ORDER BY datetime ASC LIMIT 1";
    ...
    ///zweiter Wert Pro Monat
        $last_query = "SELECT datetime,Regen FROM wetterdaten01 PARTITION (p_wetterdaten_act_08) ORDER BY datetime DESC LIMIT 1";
