...
if($db->connect_errno)
        ...
        {
                $get_minmaxavg = "SELECT date(datetime),Max(Temperatur),AVG(Temperatur),Min(Temperatur),Regen from wetterdaten01 group by date(datetime)$sort LIMIT $amount_datasets";
