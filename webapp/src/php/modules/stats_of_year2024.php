<?php
            ...
            if($db->connect_errno)
                    ...
                    else
                    {
                        ...
                        ";
                            $get_topwerte = "SELECT Temperatur, DATE_FORMAT(datetime,'%d.%m.%Y') FROM wetterdaten2024 WHERE Temperatur=(SELECT MAX(Temperatur) FROM wetterdaten2024) LIMIT 1;";
                            ...
                            $get_topwerte04="SELECT Temperatur, DATE_FORMAT(datetime,'%d.%m.%Y') FROM wetterdaten2024 WHERE Temperatur=(SELECT MIN(Temperatur) FROM wetterdaten2024) LIMIT 1;";
                            ...
                            $get_topwerte02="SELECT Windboen, DATE_FORMAT(datetime,'%d.%m.%Y') FROM wetterdaten2024 WHERE Windboen=(SELECT MAX(Windboen) FROM wetterdaten2024) LIMIT 1;";
                            ...
                            //Vierte Abfrage
                            $get_topwerte4="SELECT (SELECT MAX(Regen) FROM wetterdaten2024)-(SELECT min(Regen) FROM wetterdaten2024) AS Gesamt;";
                            ...
                            $get_avg_jahresmittel="Select AVG(Temperatur) AS Jahresmitteltemperatur from wetterdaten2024";
                            ...
                            $get_warme_tage="SELECT COUNT(*) from tageshöchstwerte24 WHERE Höchstwert BETWEEN 25 AND 29.9";
                            ...
                            $get_heiße_tage="SELECT COUNT(*) from tageshöchstwerte24 WHERE Höchstwert BETWEEN 30 AND 34.9";
                            ...
                            $get_wuesten_tage="SELECT COUNT(*) from tageshöchstwerte24 WHERE Höchstwert >= 35;";
                            ...
                            $get_avg_feuchte="Select AVG(Feuchte) AS Mittlerefeuchte from wetterdaten2024;";
                            ...
                            $get_max_pressure="Select date(datetime), MAX(airpressure) AS MaxPressure from airpressure2024;";
                            ...
                            $get_min_pressure="Select date(datetime), MIN(airpressure) AS MINPressure from airpressure2024;";
                            ...
                            $get_avg_pressure="Select date(datetime), AVG(airpressure) AS AVGPressure from airpressure2024;";
